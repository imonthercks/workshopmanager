...
namespace WorkshopManager.Admin
{
    public class RavenUserAccountRepository :
        ...
        IUserAccountQuery<HierarchicalUserAccount>
    {
        ...
        public IEnumerable<UserAccountQueryResult> Query(Func<IQueryable<HierarchicalUserAccount>, IQueryable<HierarchicalUserAccount>> filter)
        {
            var f = filter(null);
            return new List<UserAccountQueryResult>();
        }

        public IEnumerable<UserAccountQueryResult> Query(Func<IQueryable<HierarchicalUserAccount>, IQueryable<HierarchicalUserAccount>> filter, Func<IQueryable<HierarchicalUserAccount>, IQueryable<HierarchicalUserAccount>> sort, int skip, int count, out int totalCount)
        {
            var f = filter(items);
